        ...
        <div className={'relative flex flex-col gap-5'}>
          ...
          <div className={'flex w-[775px] flex-col items-start justify-center'}>
            ...
            <p
              ...
              <span className={'text-secondary'}>Need</span> Kitchen,
              <br></br> gadgets?
            </p>
            {/*search textfield*/}
            <div
            ...
            {/*We got you covered sentence*/}
            <p
              className={`${rubikBold.variable} text-center font-rubik text-[2rem] text-opposite`}>
              <span className={'text-secondary'}>We</span> got you{' '}
              <span className={'text-secondary'}>covered!</span>
            </p>
          </div>
